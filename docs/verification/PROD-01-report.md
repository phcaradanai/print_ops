...
| --- | --- | --- |
| AUTOMATED | PARTIAL | API 42 files/342 tests, web 23 files/453 tests, API/web typechecks and builds, Go suite, and Rust suite pass; bound-port, real NATS, Playwright, migration, and packaged smoke automation remain incomplete. |
...
| API-01 | Existing API regression suite stays green | 42 files / 342 tests pass | Local command output, 2026-07-31 | PASS | Bound-port and real-service integration remain |
