...
| --- | --- | --- |
| AUTOMATED | PARTIAL | API 44 files/349 tests, web 23 files/453 tests, API/web typechecks and builds, Go suite, Rust suite, and SQLite migration/backup automation pass; bound-port, real NATS, Playwright, and packaged smoke automation remain incomplete. |
...
| API-01 | Existing API regression suite stays green | 44 files / 349 tests pass | Local command output, 2026-07-31 | PASS | Bound-port and real-service integration remain |
