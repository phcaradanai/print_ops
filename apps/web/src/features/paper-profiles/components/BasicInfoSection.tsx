      ...
      <Section title={t('page.paperProfiles.basicInfo')} icon="📄"
        ...
        <div className="pp-form-grid pp-form-grid--two">
          <div>
            ...
            <input value={editor.form.code} onChange={(event) => editor.patchForm('code', event.target.value)}
          ...
          <div>
            ...
            <input value={editor.form.name} onChange={(event) => editor.patchForm('name', event.target.value)}
