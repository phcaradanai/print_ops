...
const paths: Record<ActionIconName, ReactNode> = {
  ...
  eyeOff: <><path d="M2 2l12 12" /><path d="M6.15 4.28A7.2 7.2 0 0 1 8 4c4.25 0 6.5 4 6.5 4s-2.25 4-6.5 4a7.2 7.2 0 0 1-1.85-.28M9.72 11.72A7.2 7.2 0 0 1 8 12c-4.25 0-6.5-4-6.5-4a9.7 9.7 0 0 1 1.56-2.02M6.6 6.6a2 2 0 0 0 2.8 2.8" /></>,
